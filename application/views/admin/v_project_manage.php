            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a id="btn_add_prj" class="<?php echo($this->config->item("btn_add_color")) ?>" href=" <?php echo (site_url().'/admin/Sms_base_data/mission_ind/'.'1') ?>" ><i class=" <?php echo $this->config->item('sms_icon_add'); ?>" aria-hidden="true"></i> เพิ่มโครงการ</a>
                        </div>
                        <!-- ./col md 2 -->
                        <div class="col-md-10">
                        </div>
